...
void solve() {   
  int xa,ya,xb,yb,xc,yc;cin>>xa>>ya>>xb>>yb>>xc>>yc;
    if(xa+xb==0&&yc==0||ya+yb==0&&yc==0||xa+xc==0&&yb==0||ya+yc==0&&yb==0||xb+xc==0&&ya==0||yb+yc==0&&ya==0||ya+yb==0&&xc==0||xa+xb==0&&xc==0||ya+yc==0&&xb==0||xa+xc==0&&xb==0||yb+yc==0&&xa==0||xb+xc==0&&xa==0){
        cout<<"YES\n";
    }else{
        cout<<"NO\n";
    }
